 ...
 */
final class Version20221123193102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_details (id INT AUTO_INCREMENT NOT NULL, order__id INT NOT NULL, product VARCHAR(255) NOT NULL, quantity INT NOT NULL, price_product DOUBLE PRECISION NOT NULL, total DOUBLE PRECISION NOT NULL, INDEX IDX_845CA2C1251A8A50 (order__id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
